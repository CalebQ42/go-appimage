...
//go:embed ../../data/appimage.png
var _dataAppimagePng []byte

func dataAppimagePngBytes() ([]byte, error) {
	return bindataRead(
		_dataAppimagePng,
		"data/appimage.png",
	)
...
var _bindata = map[string]func() (*asset, error){
	"data/appimage.png": dataAppimagePng,
}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"data": {nil, map[string]*bintree{
		"appimage.png": {dataAppimagePng, map[string]*bintree{}},
	}},
}}
